...
const UpcomingAuctions = () => {
  ...
  return (
    <section
      ref={ref}
      className={`py-12 sm:py-16 lg:py-20 xl:py-24 bg-[#040B1A] bg-gradient-to-b from-[#040B1A] via-[#0a1a2d] to-[#0B1C2F] transition-all duration-1000 ${
        inView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-16'
      }`}
    >
      <div className="max-w-7xl mx-auto px-6 md:px-10">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-20">
          <SectionTitle title="Upcoming Auctions" subtitle="Reserve Your Seat" className="max-w-2xl" />
          <Link
            to="/auctions"
